...
use App\Http\Resources\ward\menu\MenuSaveResource;
use App\Http\Resources\ward\menu\MenuTreeResource;
use App\Http\Resources\ward\menu\MenuViewResource;
...
class MenuController extends Controller
{
    ...
    public function reorder(): JsonResponse {
        ...
        DB::transaction(function () {
            Query::recursiveItemsReorder(request('items'), function ($data, $index) {
