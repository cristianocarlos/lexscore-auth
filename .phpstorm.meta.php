...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'session.refresh_token_domain' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./private/var/www/lexscore/auth/public/storage',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.cloudflare_turnstile_ward.secret_key','services.cloudflare_turnstile_ward.verify_url',
...
'session.partitioned','session.refresh_token_domain','scramble.api_path','scramble.api_domain','scramble.export_path',
